...
import { Container, Header, Content, Text, Button, Icon, Card, CardItem, Input,Title , Left, Right, Body, Item , Label  } from "native-base";
                        ...
                        <Grid>
                            <Row style={{ ...styles.inputContainer, ...{flexDirection: "row", margin: 10}}}>
                                <Col style={styles.input}>
                                    ...
                                    <Input value="Geek" placeholderTextColor={commonColor.lightThemePlaceholder}/>
                                    </Item>
                                </Col>
                                <Col style={styles.input}>
                                     <Item stackedLabel style={{borderBottomWidth:1 ,marginHorizontal :10 }}>
                                     <Label note>LAST NAME</Label>
                                    <Input value="Rishabh" placeholderTextColor={commonColor.lightThemePlaceholder}/>
                                    </Item>
                                </Col>
                            </Row>
                            <Row style={{ ...styles.input, ...{marginLeft: 10}}}>
                                ...
                                <Item stackedLabel style={{borderBottomWidth:1 ,marginHorizontal :10}}>
                                    ...
                                    <Input value="geekrishabh@gmail.com" placeholderTextColor={commonColor.lightThemePlaceholder}/>
                                 </Item>
                                 </Col>
                                </Row>
                            ...
                            <Card style={styles.inputContainer}>
                                ...
                                <CardItem style={styles.blueBorder}>
                                    ...
                                    <CardItem button style={{borderBottomWidth: 0}}>
                                        ...
                                        <Body><Text>Work</Text>
                                        <Text note>GeekyAnts</Text></Body></Left>
                                    </CardItem>
