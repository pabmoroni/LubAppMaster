      ...
      <View style={{ flex: 1 }}>
        ...
        <View style={styles.slideSelector}>
          <Card style={{ flexDirection: "row", bottom: 5 }}>
            ...
            <CardItem style={styles.selectCardContainer}>
              <TouchableOpacity
                ...
                onPress={() => Actions.payment({ type: ActionConst.REPLACE })}
              >
                <Image
          ...
          <Button
            ...
            onPress={() => Actions.rideBooked({ type: ActionConst.REPLACE })}
          >
        ...
        <View style={{ position: "absolute", top: 0, width: width + 5 }}>
          ...
          >
            ...
            <Body>
              <Title style={{ color: commonColor.brandPrimary }}>Confirmation</Title>
            </Body>
            <Right />
          </Header>
          <View
              ...
              <View style={styles.searchBarIn}>
                ...
                >
                  <Input
                    ...
                    value="West Menlo Park, California, 94025, USA"
                    style={{
                      textAlign: "center",
                      color: "green",
                      marginLeft: 15,
