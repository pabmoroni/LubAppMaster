                    ...
                    <Content style={{ backgroundColor: "#eee",marginBottom: (Platform.OS === "ios") ? 0 : -10 }}>
                        <View style={{padding: 15}}>
                            <Card style={{ position:"relative" }}>
                                ...
                                <Image source={require("../../../../assets/images/dummyMap.png")} style={{ resizeMode: "cover", opacity: this.state.opacity, height: 300, width: null, flex: 1}}/>

                                </CardItem>
                                 <CardItem style={styles.detailContainer}>
                                   <Left><Thumbnail square small source={require("../../../../assets/images/Contacts/avatar-1.jpg")} size={40} style={styles.driverImage} />
                        ...
                        <View style={{padding: 15,paddingTop: 0}}>
                            <Card style={{position:"relative"}}>
                                ...
                                <Image source={require("../../../../assets/images/dummyMap.png")} style={{ resizeMode: "cover", opacity: this.state.opacity}}/>

                                </CardItem>
                                 <CardItem style={styles.detailContainer}>
                                    <Left><Thumbnail square small source={require("../../../../assets/images/Contacts/avatar-2.jpg")} size={40} style={styles.driverImage} />
                        ...
                        <View style={{padding: 15,paddingTop: 0}}>
                            <Card style={{position:"relative"}}>
                                ...
                                <Image source={require("../../../../assets/images/dummyMap.png")} style={{ resizeMode: "cover", opacity: this.state.opacity}}/>
                                 ...
                                 <CardItem style={styles.detailContainer}>
                                    <Left><Thumbnail square small source={require("../../../../assets/images/Contacts/avatar-3.jpg")} size={40} style={styles.driverImage} />
                        ...
                        <View style={{padding: 15,paddingTop: 0}}>
                            <Card style={{position:"relative"}}>
                                ...
                                <Image source={require("../../../../assets/images/dummyMap.png")} style={{ resizeMode: "cover", opacity: this.state.opacity}}/>
                                 ...
                                 <CardItem style={styles.detailContainer}>
                                    <Left><Thumbnail square small source={require("../../../../assets/images/Contacts/avatar-4.jpg")} size={40} style={styles.driverImage} />
                        ...
                        <View style={{padding: 15,paddingTop: 0}}>
                            <Card style={{position:"relative"}}>
                                ...
                                <Image source={require("../../../../assets/images/dummyMap.png")} style={{ resizeMode: "cover", opacity: this.state.opacity}}/>
                                 ...
                                 <CardItem style={styles.detailContainer}>
                                    <Left><Thumbnail square small source={require("../../../../assets/images/Contacts/avatar-5.jpg")} size={40} style={styles.driverImage} />
