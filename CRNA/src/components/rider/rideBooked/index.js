        ...
        return (
                <View style={{flex: 1}}>
                    ...
                    <CardItem>
                        <Grid style={{flexDirection: "row",borderWidth:0}}>
                            <Col style={styles.driverInfoContainer}>
                                <Thumbnail square size={60} source={require("../../../../assets/images/Contacts/avatar-9.jpg")} style={{borderRadius: 30}} />
                    ...
                    <Header androidStatusBarColor={commonColor.statusBarLight} style={Platform.OS === "ios" ? styles.iosHeader : styles.aHeader }>
                      ...
                      <Body><Title style={{color: commonColor.brandPrimary }}>En Route</Title></Body><Right/>
                    </Header>
