                ...
                <View style={{flex: 1}}>
                    ...
                    >
                        <View style={{height: height,backgroundColor: commonColor.brandPrimary }}>
                          <Header  style={{ ...{backgroundColor: commonColor.brandPrimary, borderBottomWidth: 0}, ...Platform.OS === "ios" ? {} : styles.modalHeader}} androidStatusBarColor={commonColor.statusBarColorDark}>
