        ...
        return (
                <View style={{flex: 1}}>
                    <Content />
                        ...
                        <Image source={require("../../../../assets/images/dummyMap.png")} style={{ ...Platform.OS === "ios" ? {height: height} : {height: height}, opacity: this.state.opacity }}/>
                    ...
                    >
                        <View style={{height: height,backgroundColor: commonColor.brandPrimary}}>
                          <Header androidStatusBarColor={commonColor.statusBarColorDark} style={{ ...{backgroundColor: commonColor.brandPrimary, borderBottomWidth:0}, ...Platform.OS === "ios" ? {} : styles.modalHeader }} iosBarStyle="light-content">
