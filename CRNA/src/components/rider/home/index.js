        ...
        return (
                <View style={styles.container}>
                    <Content />
                        ...
                        <Image source={require("../../../../assets/images/dummyMap.png")} style={{height: height, opacity: this.state.opacity}}/>
                    ...
                    <Header  iosStatusbar="default" style={Platform.OS === "ios" ? styles.iosHeader : styles.aHeader } androidStatusBarColor={commonColor.statusBarLight}>
                       ...
                       <Body><Title style={{color: commonColor.brandPrimary,marginTop: -2}}>Taxi App</Title></Body><Right/>
                    </Header>
                        ...
                        <Grid>
                            ...
                            <Col size={4} style={{ justifyContent:"center", alignItems: "center", marginLeft: -120 }}>
                                ...
                                <Row style={ Platform.OS === "android" ? {marginTop: -20, left: -10 } : {marginTop: -30 , padding: 5, left: -10 }}>
                                   <Item regular style={(Platform.OS === "android") ? { flex: 1, alignItems: "center", borderWidth: 0, paddingBottom: 5, borderColor: "transparent"} : {flex: 1, alignItems: "center", borderColor: "transparent"}}>
                                       <Input placeholder="Go To Pin" placeholderTextColor={commonColor.lightThemePlaceholder} style={{ top:(Platform.OS === "ios") ? 2 : 2, fontSize:15, textAlign: "center"}}/>
                                   </Item>
                                </Row>
                            </Col>
                        </Grid>
